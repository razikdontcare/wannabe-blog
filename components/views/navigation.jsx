  ...
  return (<>
    <nav className="p-3 shadow bg-primary text-white">
      <div className="container mx-auto max-w-5xl flex items-center justify-between">
        ...
        <a href="/login" className="px-6 py-2 font-bold rounded-xl text-primary bg-secondary border-2 border-transparent hover:border-2 hover:border-secondary hover:bg-transparent hover:text-secondary transition-all duration-300">Sign In</a>
      </div>
    </nav>
  </>);
}
